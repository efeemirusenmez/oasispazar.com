...
<head>
	...
	<title>oasispazar.com - Kayıt Ol</title>
</head>
<body>
	...
	<section class="form-container">
		...
		<form method="post">
			...
			<input type="password" name="cpassword" placeholder="şifrenizi tekrardan giriniz" required>
			<input type="submit" name="submit-btn" value="kayıt ol" class="btn">
			<p>Zaten hesabınız var mı? <a href="login.php">Giriş Sayfası</a></p>
		</form>
	</section>
</body>
</html>